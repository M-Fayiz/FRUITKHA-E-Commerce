...
const user_Contrl=require('../controller/USER-CNTRL/user.controller')
const passport = require('passport')
const PROFILE=require('../controller/USER-CNTRL/profile.controller')
const ADDRES=require('../controller/USER-CNTRL/address.controller')
const CART=require('../controller/USER-CNTRL/cart.controller')
const CHECKOUT=require('../controller/USER-CNTRL/check-out.controller')
const WISHLIST=require('../controller/USER-CNTRL/wishList.controller')
const COUPON=require('../controller/ADMIN/coupon.controller')
const ORDER=require('../controller/ADMIN/order.controller')
const WALLET=require('../controller/USER-CNTRL/wallet.controller')
const userOrder=require('../controller/USER-CNTRL/userOrder.controller')
